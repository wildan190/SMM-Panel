...
class Recaptcha
{
    ...
    public function __construct()
    {
        ...
        $this->_ci->load->model('website_config_model');
        // Menggunakan fungsi helper untuk mendapatkan nilai konfigurasi
        $this->_siteKey = website_config('gr_site_key');
        $this->_secretKey = website_config('gr_secret_key');
        $this->_language = 'id';
