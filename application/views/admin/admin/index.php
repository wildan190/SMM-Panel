	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header">
				<h4 class="mb-0"><i class="fas fa-user-secret me-2"></i>Data Admin</h4>
			</div>
			<div class="card-body">
...
<script type="text/javascript">
	function confirm_hapus(id) {
		Swal.fire({
			title: 'Yakin ingin menghapus Data Admin #' + id + '?',
			type: 'question',
			...
			if (result.value) window.location = "<?= base_url() ?>admin/admin/delete/" + id
		})
	}
</script>