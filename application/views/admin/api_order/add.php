...
<form class="form-horizontal" method="post" action="<?= base_url('admin/api_order/form') ?>">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="order_id_key" name="order_id_key" placeholder="Contoh: id, order_id">
            </div>
            <hr class="mt-1">
        </div>
    </div>
