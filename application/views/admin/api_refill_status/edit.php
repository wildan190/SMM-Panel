<form class="form-horizontal" method="post" action="<?= base_url('admin/api_refill_status/form/' . $target->api_id) ?>">
                ...
                <div id="parameter">
                    <?php if (!empty($api_request_param)) {
                        foreach ($api_request_param as $key => $value) {
                            if ($value['api_type'] == 'refill_status') {
                            }
                    ?>
                                ...
                                <div class="form-group col-4" id="form_pv_<?= $value['id'] ?>">
                                    ...
                                    <?php } else { ?>
                                        <select class="select2-data form-control" id="param_value_<?= $value['id'] ?>" name="param_value[]">
                                            ...
                                            <option value="refill_id" <?= ($value['param_value'] == 'refill_id') ? 'selected' : ''; ?>>Refill ID</option>
                                        </select>
                                    <?php } ?>
                                </div>
