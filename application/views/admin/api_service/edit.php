<form class="form-horizontal" method="post" action="<?= base_url('admin/api_service/form/' . $target->api_id) ?>">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?= $target->end_point ?>" id="end_point" name="end_point">
            </div>
            <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="data_service_key" name="data_service_key" value="<?= $target->data_service_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Response Service ID <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="service_id_key" name="service_id_key" value="<?= $target->service_id_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Response Service Category <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="category_key" name="category_key" value="<?= $target->category_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Response Service Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="service_name_key" name="service_name_key" value="<?= $target->service_name_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Response Service Price <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="price_key" name="price_key" value="<?= $target->price_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Response Service Min <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="min_key" name="min_key" value="<?= $target->min_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Response Service Max <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="max_key" name="max_key" value="<?= $target->max_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="description_key" name="description_key" value="<?= $target->description_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Response Service Refill <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="refill_key" name="refill_key" value="<?= $target->refill_key ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Response Service Type <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="type_key" name="type_key" value="<?= $target->type_key ?>">
                    </div>
                </div>
            </div>
            <hr class="mt-1">
