				<div class="row">
					<div class="col-md-12">
        				...
        				<a href="<?= base_url('admin/'.$this->uri->segment(2).'/form') ?>" class="btn btn-primary mb-3 me-1"><i class="fas fa-plus-circle fs-6 me-2"></i>Tambah</a>
						<div class="card">
							<div class="card-header">
								<h4 class="mb-0"><i class="fas fa-cogs me-2"></i>Data API Status Pesanan</h4>
							</div>
							<div class="card-body">
								<div class="table-responsive table-card mb-2">
									...
									?>
												<tr>
													...
													<td align="center">
													<a href="<?= base_url('admin/'.$this->uri->segment(2).'/form/'.$value['api_id']) ?>" class="btn btn-warning round btn-sm me-1" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ubah"><i class="fas fa-edit fs-6 me-2"></i>Ubah</a>
													<a href="javascript:;" onclick="confirm_hapus('<?= $value['api_id'] ?>')" class="btn btn-danger round btn-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Hapus"><i class="fas fa-trash fs-6 me-2"></i>Hapus</a>
												</td>
												</tr>
									<?php
									}
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="myLargeModalLabel"><i class="fas fa-filter fs-6 me-2"></i></i>Filter Data</h5>
...
function confirm_hapus(api_id) {
	Swal.fire({
		...
		if (result.value) window.location = "<?= base_url() ?>admin/api_status/delete/" + api_id
	})
}
</script>