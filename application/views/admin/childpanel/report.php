                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        <tr class="table-success">
                            ...
                            <td>Rp
                                <?= currency($widget['success'][0]['rupiah']) ?> dari
                                <?= currency($widget['success'][0]['total']) ?> pesanan.
                            </td>
                        </tr>
                        <tr class="table-warning">
                            <th width="30%">Pending</th>
                            <td>Rp
                                <?= currency($widget['pending'][0]['rupiah']) ?> dari
                                <?= currency($widget['pending'][0]['total']) ?> pesanan.
                            </td>
                        </tr>
                        <tr class="table-danger">
                            <th width="30%">Canceled</th>
                            <td>Rp
                                <?= currency($widget['canceled'][0]['rupiah']) ?> dari
                                <?= currency($widget['canceled'][0]['total']) ?> pesanan.
                            </td>
                        </tr>
                    </table>
                </div>
