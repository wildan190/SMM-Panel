	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header">
				<h4 class="mb-0"><i class="far fa-credit-card me-2"></i>Data Deposit</h4>
			</div>
			<div class="card-body">
							...
							?>
								<tr>
									...
									<td>
										<div class="row align-items-center">
											...
											<div class="col" style="margin-right: 1rem !important">
												<h6 class="mb-1"><span class="text-truncate w-100"><?= $method->name ?></span></h6>
												<p class="text-muted f-12 mb-0"><span class="text-truncate w-100"><?= $this->lib->tanggal_indonesia($value['created_at']) ?></span></p>
											</div>
										</div>
									</td>
									<td>
										<div class="row align-items-center">
											<div class="col">
												<p class="f-14 mb-0"><span class="text-truncate">• Jumlah Pembayaran <b>Rp <?= number_format($value['amount'], 0, ',', '.') ?></b></span></p>
												<p class="f-14 mb-0"><span class="text-truncate">• Saldo diterima <b>Rp <?= number_format($value['balance'], 0, ',', '.') ?></b></span></p>
											</div>
										</div>
									</td>
									<td align="center">
									...
									<td>
										...
										<?php } ?>
										<a href="javascript:;" onclick="modal_open('detail', 'lg', '<?= base_url('admin/' . $this->uri->segment(2) . '/detail/' . $value['id']) ?>')" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Detail"><i class="fas fa-search fs-6 me-2"></i>Detail Data</a>
...
<script type="text/javascript">
	...
	function confirm_hapus(id) {
		Swal.fire({
			title: 'Yakin ingin menghapus Data Deposit #' + id + '?',
			icon: 'question',
