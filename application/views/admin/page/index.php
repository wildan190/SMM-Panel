		...
		<a href="<?= base_url('admin/'.$this->uri->segment(2).'/form') ?>" class="btn btn-primary mb-3 me-1"><i class="fas fa-plus-circle fs-6 me-2"></i>Tambah Data</a>
						<div class="card">
							<div class="card-header">
								<h4 class="mb-0"><i class="fas fa-file me-2"></i>Data Halaman</h4>
							</div>
							<div class="card-body">
								<div class="table-responsive table-card mb-2">
									...
									?>
												<tr>
													...
													<td><?=  $this->lib->format_date($value['updated_at']) ?></td>
													<td align="center">
...
function confirm_hapus(id) {
	Swal.fire({
		title: 'Yakin ingin menghapus Data Halaman #' + id + '?',
		icon: 'warning',
		type: 'question',
		...
		if (result.value) window.location = "<?= base_url() ?>admin/page/delete/" + id
	})
}
</script>