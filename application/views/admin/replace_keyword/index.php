        ...
        <a href="<?= base_url('admin/'.$this->uri->segment(2).'/form') ?>" class="btn btn-primary mb-3 me-1"><i class="fas fa-plus-circle fs-6 me-2"></i>Tambah</a>
						<div class="card">
							<div class="card-header">
								<h4 class="mb-0"><i class="fas fa-file me-2"></i>Filter Pembaruan Layanan</h4>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									...
									?>
												<tr>
													...
													<td><?= $value['target'] ?></td>
													<td align="center">
														<a href="<?= base_url('admin/'.$this->uri->segment(2).'/form/'.$value['id']) ?>" class="btn btn-warning round btn-sm me-1" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ubah"><i class="fas fa-edit fs-6 me-2"></i>Ubah</a>
				...
				<div class="modal fade filter-target" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<a href="javascript:void(0);" class="btn btn-danger" data-bs-dismiss="modal"><i class="fas fa-cancel fs-6 me-2"></i>Tutup</a>
							</div>
						</div>
					</div>
				</div>
...
function confirm_hapus(id) {
	Swal.fire({
		title: 'Konfirmasi',
		html: 'Yakin ingin menghapus Filter Pembaruan Layanan #' + id + '?',
		icon: 'question',
		...
		if (result.value) window.location = "<?= base_url() ?>admin/replace_keyword/delete/" + id
	})
}
</script>