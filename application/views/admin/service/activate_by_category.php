            ...
            <div class="card-body">
                <form method="post" class="mb-4">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-4">
                            <button type="submit" class="btn btn-success w-100" onclick="return confirm('Apakah Anda yakin ingin mengaktifkan semua layanan dalam kategori ini?');"><i class="fas fa-power-on me-2"></i>Aktifkan Layanan</button>
                        </div>
                    </div>
                </form>
