    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="fas fa-tags me-2"></i>Layanan Rekomendasi</h4>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;" onclick="modal_open('detail', 'lg', '<?= base_url('admin/service/detail/' . $value['service_id']) ?>')"> <?= $value['service_id'] ?></a>
                                    </td>
                                    <td>
                                        <?= $value['service_name'] ?>
                                    </td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 hstack justify-content-end">
                        <span class="text-muted">Total data:
                            <?= $total_data ?>
                        </span>
                    </div>
                </div>
...
<script type="text/javascript">
    function confirm_hapus(id) {
        Swal.fire({
            title: 'Konfirmasi',
            icon: 'warning',
            html: 'Yakin ingin menghapus Layanan Rekomendasi <b>#' + id + '</b> ?',
            ...
            if (result.value) window.location = "<?= base_url() ?>admin/service_recommended/delete/" + id
        })
    }
</script>