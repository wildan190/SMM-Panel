<div class="row">
    <div class="col-md-12">
        <a href="<?= base_url('admin/ticket') ?>" class="btn btn-primary mb-3"><i
                class="fas fa-arrow-circle-left fs-6 me-2"></i>Kembali</a>
    </div>
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body pb-4">
                <div class="table-responsive">
                    <table class="table table-bordered mb-0">
                        ...
                        <tr>
                            <td>
                                <span class="fw-bold">Pengguna</span><br>
                                <?= $user->username ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <?= ($target->type === 'order') ? 'Pesanan' :
                                    (($target->type === 'deposit') ? 'Deposit' :
                                        (($target->type === 'service') ? 'Layanan' : 'Lainnya')) ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr class="x-chats">
                            <td>
                                ...
                                <?= $this->lib->format_date($target->updated_at) ?>
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-body chat-body hide-scrollbar flex-1 h-100 pt-0" style="max-height: 530px;">
                <div class="chat-body-inner">
                    ...
                    foreach ($ticket_reply as $key => $value) {
                        ...
                        ?>
                        <div class="message<?php echo ($value['sender'] == 'admin') ? ' message-out' : '' ?>">
                            <!--<a href="#" data-bs-toggle="modal" data-bs-target="#modal-profile" class="avatar avatar-responsive" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-html="true" title="<b class='text-success' style='letter-spacing:0.1em;'>[Anda]</b> Aditdev Developer">-->
                            <a class="avatar avatar-responsive" data-bs-toggle="tooltip" href="javascript:;"
                                data-bs-placement="<?php echo ($value['sender'] == 'admin') ? 'right' : 'left' ?>"
                                data-bs-html="true"
                                title="<b class='text-success' style='letter-spacing:0.1em;'><?php echo ($value['sender'] == 'admin') ? '[Admin] ' : '[User] ' ?></b><?php echo ($value['sender'] == 'admin') ? 'Heru Suandana' : '' . $user->full_name . '' ?>">
                                <img class="avatar-img" src="<?= base_url() ?>assets/images/male.jpg" alt="">
                            </a>
                ...
                <form method="POST" class="needs-validation">
                    ...
                    <div class="mb-0">
                        <button type="submit" class="btn btn-primary float-end"><i
                                class="fas fa-reply fs-6 me-2"></i>Kirim</button>
