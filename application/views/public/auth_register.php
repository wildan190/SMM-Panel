...
<head>
    ...
    <title><?= website_config('title_register') ?></title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="<?= website_config('meta_description_register') ?>" />
    <meta name="keywords" content="<?= website_config('meta_keywords_register') ?>" />
    ...
    <meta property="og:title" content="<?= website_config('title_register') ?>" />
    <meta property="og:description" content="<?= website_config('meta_description_register') ?>" />
    <meta property="og:url" content="<?= base_url() ?>" />
    <meta property="og:site_name" content="<?= website_config('title_register') ?>" />
    ...
    <meta property="og:image:alt" content="<?= website_config('title_register') ?>" />
    <meta property="og:image:type" content="image/jpg" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="<?= website_config('title_register') ?>" />
    <meta name="twitter:description" content="<?= website_config('meta_description_register') ?>" />
    <meta name="twitter:image" content="<?= base_url() ?>uploads/website/<?= website_config('logo') ?>" />
    <meta name="twitter:label1" content="Written by" />
    <meta name="twitter:data1" content="<?= website_config('title_register') ?>" />
