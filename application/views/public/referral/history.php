    ...
    <div class="col-md-12">
                        ...
                        <form method="get" class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="select2 form-control" name="sort_field">
                                    ...
                                    <option value="amount">JUMLAH SALDO</option>
                                    <option value="created_at">TGL. CONVERT</option>
                                </select>
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-6 d-grid">
                                <a href="<?= base_url() ?>referral/history" class="btn btn-danger"><i class="fas fa-sync fs-6 me-2"></i>Reset</a>
                            </div>
                            <div class="form-group col-md-6 d-grid">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="fas fa-history me-2"></i>Riwayat Convert</h4>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover m-0" id="table-data">
                        <thead>
                            <tr class="">
                                <th>ID</th>
                                <th class="text-nowrap">Jumlah Saldo</th>
                                <th class="text-nowrap">Tgl. Convert</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
