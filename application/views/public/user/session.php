    ...
    <div class="col-md-12">
                    ...
                    <div class="modal-body pb-0">
                        <form method="get" class="row">
                            ...
                            <div class="form-group col-md-6 d-grid">
                                <a href="<?= base_url() ?>user/session" class="btn btn-danger"><i class="fas fa-sync fs-6 me-2"></i>Reset</a>
                            </div>
                            <div class="form-group col-md-6 d-grid">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="fab fa-firefox-browser me-2"></i>Sesi Aktif</h4>
            </div>
...
<script type="text/javascript">
    function confirm_cabut(id) {
        Swal.fire({
            ...
            if (result.value) window.location = "<?= base_url() ?>user/cabut_sesi/" + id
        })
    }
</script>